...
#include "../QT-myChat-Server/Tools/log.h"
...
QT_MOC_LITERAL(1, 4, 12), // "readyShowLog"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 3) // "log"

    },
    "Log\0readyShowLog\0\0log"
};
...
void Log::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readyShowLog((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Log::readyShowLog)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Log::readyShowLog(QString _t1)
{
